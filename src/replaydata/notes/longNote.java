...
public class longNote implements Note {
  ...
  private final boolean releaseOffMap = false;
  private boolean heldDown = false;
  private boolean hitBefore = false;
  private boolean excludeFromJudges = false;
  private final boolean doNotDelete = false;
  private final int OD;
  private final ImageGrabber imageGrabber;

  //to ensure rice notes/lns ahead of the current ln don't allow a misjudgement
  private boolean allowedToAccept = false;
...
//  public void calcOnFullHold(renderer.GameRenderer game) {
//
